...
public class B314commentsSyntaxTest {
    ...
    @Test
    public void testcomments_description_monde_ok() throws Exception{
        CompilerTestHelper.launchCompilation("/syntax/comments/ok/description_monde.b314", testFolder.newFile(), true, "comments: description_monde");
    }

    @Test
    public void testcomments_parentheses_intExp_ok() throws Exception{
        CompilerTestHelper.launchCompilation("/syntax/comments/ok/parentheses_intExp.b314", testFolder.newFile(), true, "comments: parentheses_intExp");
    }
    ...
    //
    @Test
    public void testcomments_wrong_array_size_ko_ko() throws Exception {
        CompilerTestHelper.launchCompilation("/syntax/comments/ko/wrong_array_size_ko.b314", testFolder.newFile(), false, "comments: wrong_array_size_ko");
    }
